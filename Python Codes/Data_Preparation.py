...
# Save outputs
pd.concat(all_lstm, ignore_index=True).to_csv(
    f"{folder_name}/synthetic_lstm_ready_data.csv", index=False)
pd.concat(all_xgb, ignore_index=True).to_csv(
    f"{folder_name}/synthetic_chlorophyll_features.csv", index=False)
